...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.actionEventLog.setObjectName(u"actionEventLog")
        self.actionEventLog.setCheckable(True)
        self.actionAutoPowerCalibration = QAction(MainWindow)
        self.actionAutoPowerCalibration.setObjectName(u"actionAutoPowerCalibration")
        ...
        self.connectionBanner.setObjectName(u"connectionBanner")
        ...
        self.ledArduinoStatus.setStyleSheet(u"background-color: rgb(255, 11, 3); border: 0px; padding: 3px; border-radius: 8px")
        ...
        self.ledSampleStatus.setStyleSheet(u"background-color: rgb(255, 11, 3); border: 0px; padding: 3px; border-radius: 8px")
        ...
        self.ledDetectorStageStatus.setStyleSheet(u"background-color: rgb(255, 11, 3); border: 0px; padding: 3px; border-radius: 8px")
        ...
        self.ledDetectorStatus.setStyleSheet(u"background-color: rgb(255, 11, 3); border: 0px; padding: 3px; border-radius: 8px")
        ...
        self.dockEventLog.setObjectName(u"dockEventLog")
        self.eventLogPanel = EventLogPanel()
        self.eventLogPanel.setObjectName(u"eventLogPanel")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.actionEventLog.setText(QCoreApplication.translate("MainWindow", u"Ereignisprotokoll anzeigen", None))
        self.actionAutoPowerCalibration.setText(QCoreApplication.translate("MainWindow", u"Automatische Leistungskalibrierung\u2026", None))
...
#if QT_CONFIG(tooltip)
        self.cbGroupLetter.setToolTip(QCoreApplication.translate("MainWindow", u"Auswahl der GP Praktikumsgruppe (Pflichtfeld)", None))
#endif // QT_CONFIG(tooltip)
        ...
        self.dockEventLog.setWindowTitle(QCoreApplication.translate("MainWindow", u"Ereignisprotokoll", None))
