...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.detRot_box.setObjectName(u"detRot_box")
        ...
        self.det_averages.setObjectName(u"det_averages")
        ...
        self.det_averageOn.setObjectName(u"det_averageOn")
        ...
        self.sampRot_box.setObjectName(u"sampRot_box")
        ...
        self.samp_averages.setObjectName(u"samp_averages")
        ...
        self.samp_averageOn.setObjectName(u"samp_averageOn")
        ...
        self.gbSpikeFilter.setObjectName(u"gbSpikeFilter")
        self.formSpikeFilter = QFormLayout(self.gbSpikeFilter)
        self.formSpikeFilter.setObjectName(u"formSpikeFilter")
        self.spikeEnabled = QCheckBox(self.gbSpikeFilter)
        self.spikeEnabled.setObjectName(u"spikeEnabled")
        ...
        self.lblSpikeMaxDelta.setObjectName(u"lblSpikeMaxDelta")
        ...
        self.spikeMaxDelta.setObjectName(u"spikeMaxDelta")
    ...
    def retranslateUi(self, Dialog):
        ...
        self.detRot_box.setTitle(QCoreApplication.translate("Dialog", u"Detektor-Rotationsstage", None))
        self.label.setText(QCoreApplication.translate("Dialog", u"Anzahl Mittelwerte", None))
        self.det_averageOn.setText(QCoreApplication.translate("Dialog", u"Mittelung aktiviert", None))
        self.sampRot_box.setTitle(QCoreApplication.translate("Dialog", u"Sample-Rotationsstage", None))
        self.label_2.setText(QCoreApplication.translate("Dialog", u"Anzahl Mittelwerte", None))
        self.samp_averageOn.setText(QCoreApplication.translate("Dialog", u"Mittelung aktiviert", None))
        self.gbSpikeFilter.setTitle(QCoreApplication.translate("Dialog", u"Spike-Filter", None))
        self.spikeEnabled.setText(QCoreApplication.translate("Dialog", u"Spike-Filter aktivieren", None))
        self.lblSpikeMaxDelta.setText(QCoreApplication.translate("Dialog", u"Max. Winkelsprung", None))
#if QT_CONFIG(tooltip)
        self.spikeMaxDelta.setToolTip(QCoreApplication.translate("Dialog", u"Maximale erlaubte Winkel\u00e4nderung pro Abtastung (100 ms). Messungen mit gr\u00f6\u00dferer \u00c4nderung werden verworfen.", None))
#endif // QT_CONFIG(tooltip)
        self.spikeMaxDelta.setSuffix(QCoreApplication.translate("Dialog", u" \u00b0/Poll", None))
    # retranslateUi
