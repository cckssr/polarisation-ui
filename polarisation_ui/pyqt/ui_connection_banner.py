...
class Ui_ConnectionBanner(object):
    def setupUi(self, ConnectionBanner):
        if not ConnectionBanner.objectName():
            ConnectionBanner.setObjectName("ConnectionBanner")
        ...
        self.lblBannerText.setObjectName("lblBannerText")
        ...
        self.btnBannerExport.setObjectName("btnBannerExport")
    ...
    def retranslateUi(self, ConnectionBanner):
        ...
        self.btnBannerExport.setText(
            QCoreApplication.translate("ConnectionBanner", "Exportieren\u2026", None)
        )
        pass
