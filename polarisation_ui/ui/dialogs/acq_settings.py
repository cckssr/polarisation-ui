...
class AcquisitionSettingsDialog(QDialog):
    ...
    def __init__(self, settings: AcquisitionSettings, parent=None):
        ...
        self.ui.spikeEnabled.toggled.connect(self.ui.spikeMaxDelta.setEnabled)
    ...
    def _apply_settings(self, settings: AcquisitionSettings) -> None:
        ...
        self.ui.spikeEnabled.setChecked(settings.spike_filter_enabled)
        self.ui.spikeMaxDelta.setValue(settings.spike_max_delta_deg)
        self.ui.spikeMaxDelta.setEnabled(settings.spike_filter_enabled)
