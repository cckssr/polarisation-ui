...
| `MEAS:ADC:VOLT?` | `<volts>` | uses current MUX and gain; 6 decimal places |
| `MEAS:ADC:TEMP?` | `<degC>` | switches ADS1220 to temp mode briefly (~50 ms at 20 SPS) |
...
| `CONF:ADC:TEMP ON\|OFF` | — | `OFF` | Pre-enable temperature mode for streaming |
...
*(Phase 2: implemented as a fresh read; Phase 3 Python client will use true cached semantics.)*
...
*Generated by Phase 2 of the polarisation-ui SCPI redesign. Regenerate after firmware changes.*
