...
static void handleSystHelp()
{
  ...
  Serial.println("  CONF:ADC:MUX  DIFF01|DIFF23|CH0|CH1|CH2|CH3|...");
  Serial.println("  CONF:ADC:GAIN 1|2|4|8|16|32|64|128");
  Serial.println("  CONF:ADC:RATE 20|45|90|175|330|600|1000  (SPS)");
...
CONF:
  ...
  Serial.println("  SENS:PDTIA:GAIN? SENS:SRC? SENS:RATE?");
  Serial.println("INITiate/ABORt:");
  Serial.println("  INIT:CONT ON|OFF  INIT:CONT?  INIT  ABOR");
  Serial.println("FETCh:");
  Serial.println("  FETC:ENC:ANGL? [A|B|BOTH]  FETC:ADC:VOLT?  FETC:ALL?");
  Serial.println("READ?  [ADC|ADC:T]");
  Serial.println("Streaming frame:");
  Serial.println("  DATA:FRAME tsMs=..,angA=..,angB=..,adcV=..,adcT=..,pdGain=..,stat=..");
  Serial.println("SYSTem:");
  Serial.println("  SYST:ERR?  SYST:VERS?  SYST:UPTIME?  SYST:HELP?");
  Serial.println("  SYST:DEB ON|OFF|?");
  Serial.println("DIAGnostic:");
  Serial.println("  DIAG:ENC? [A|B]  DIAG:ADC?  DIAG:PDTIA?  DIAG:SELF?");
  Serial.println("====================================");
}
